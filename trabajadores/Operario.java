...
public class Operario extends Trabajador {
    ...
    public Operario(String nombre, String apellidos, String dni, String direccion, long nss, int montajesRealizados) {
        super(nombre, apellidos, dni, direccion, nss, "Operario", 1200.0, "2026-01-01");
